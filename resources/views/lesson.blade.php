...
<section class="detail section" id="detail">
    <div class="detail-container grid" style="row-gap: 5rem">
        <div class="watch-data-left" id="watch-data-left">
            ...
            <iframe width="560" height="315" src="https://www.youtube.com/embed/cOhLWL9DQO4" frameborder="0" allowfullscreen></iframe>
        </div>
...
<section class="section rating">
    <div class="rating-data">
        ...
        <form style="margin-top: 1rem; display: flex; align-items: center; column-gap: 1rem;" action="{{ route('courses.rating', [$lesson->course->id]) }}" method="post">
        @csrf
