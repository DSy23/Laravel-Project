            ...
            <div class="swiper-wrapper">
              <div class="testimonial-card swiper-slide" style="text-align: center;">
                ...
                <p class="testimonial-description">
                 Great quality course assembled at one place from the internet
                </p>
                <h3 class="testimonial-date">1 Nov, 2023</h3>

                <div class="testimonial-profile" style="justify-content: center;flex-direction: column;row-gap: 1.4rem;">
                  <img
                    src="{{ asset('frontend/assets/images/Karthick Sir.jpg') }}"
                    alt=""
                    class="testimonial-profile-img"
                  />

                  <div class="testimonial-profile-data">
                    <span class="testimonial-profile-name">Dr.Karthick Panneerselvam</span>
              ...
              <div class="testimonial-card swiper-slide" style="text-align: center;">
                ...
                <h3 class="testimonial-date">Nov 6, 2023</h3>
                ...
                <div class="testimonial-profile" style="justify-content: center;flex-direction: column;row-gap: 1.4rem;">
                  ...
                  <div class="testimonial-profile-data">
                    <span class="testimonial-profile-name">John dom</span>
                    <span class="testimonial-profile-detail"
                      >User</span
                    >
                  </div>
              ...
              <div class="testimonial-card swiper-slide" style="text-align: center;">
                ...
                <h3 class="testimonial-date">Nov 7, 2023</h3>

                <div class="testimonial-profile" style="justify-content: center;flex-direction: column;row-gap: 1.4rem;">
                  <img
                    src="{{ asset('frontend/assets/images/testimonial3.jpg') }}"
                    alt=""
                    class="testimonial-profile-img"
                  />

                  <div class="testimonial-profile-data">
                    <span class="testimonial-profile-name">mark Doe</span>
                    <span class="testimonial-profile-detail"
                      ></span
                    >
                  </div>
